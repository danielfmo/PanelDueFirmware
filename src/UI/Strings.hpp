...
const StringTable LanguageTables[] =
{
	// English
	{
		...
		"Setup",
		"Pendant",
		"Current" THIN_SPACE "rpm",
		"Active" THIN_SPACE "rpm",
		"Standby" THIN_SPACE "rpm",
		"Move",
		"Extrusion",
		"Macro",
		"RESET",
	...
	// German
	{
		...
		"Einstellung",
		"Pendant",
		"Istwert" THIN_SPACE "rpm",
		"Aktiv" THIN_SPACE "rpm",
		"Standby" THIN_SPACE "rpm",
		"Bewegung",
		"Extrusion",
		"Makro",
	...
	// French
	{
		...
		"Configuration",
		"Pendant",
		"Actuel" THIN_SPACE "rpm",
		"Actif" THIN_SPACE "rpm",
		"Standby" THIN_SPACE "rpm",
		"Mouvement",
		"Extrusion",
		"Macro",
	...
	// Spanish
	{
		...
		"Configuración",
		"Pendant",
		"Actual" THIN_SPACE "rpm",
		"Activo" THIN_SPACE "rpm",
		"Inactivo" THIN_SPACE "rpm",
		"Mover",
		"Extrusión",
		"Macro",
	...
	// Czech
	{
		...
		"Nastavení",
		"Pendant",
		"Aktuální" THIN_SPACE "rpm",
		"Aktivní" THIN_SPACE "rpm",
		"Nečinná" THIN_SPACE "rpm",
		"Pohyb",
		"Extruder",
		"Makra",
		"STOP",
	...
	// Italian
	{
		...
		"Configura",
		"Pendant",
		"Corrente" THIN_SPACE "rpm",
		"Attiva" THIN_SPACE "rpm",
		"Standby" THIN_SPACE "rpm",
		"Muovi",
		"Estrusione",
		"Macro",
	...
	// Polish
	{
		...
		"Ustawienia",
		"Pendant",
		"Aktualna" THIN_SPACE "rpm",
		"Żądana" THIN_SPACE "rpm",
		"Czuwanie" THIN_SPACE "rpm",
		"Ruch",
		"Ekstruzja",
		"Polecenie",
		"STOP",
	...
	// Ukrainian
	{
		...
		"Налаштування",
		"Pendant",
		"Поточна" THIN_SPACE "rpm",
		"Активна" THIN_SPACE "rpm",
		"Очікувана" THIN_SPACE "rpm",
		"Рух",
		"Екструзія",
		"Макро",
		"СТОП",
	...
	// Russian
	{
		...
		"Настройки",
		"Pendant",
		"Текущая" THIN_SPACE "rpm",
		"Заданная" THIN_SPACE "rpm",
		"Преднагрев" THIN_SPACE "rpm",
		"Движения",
		"Экструзия",
		"Макрос",
		"СТОП",
